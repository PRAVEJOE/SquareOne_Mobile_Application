...
class AddressManagementBottomCard extends StatefulWidget {
  // CheckoutCard(double totalPrice,  {Key? key}) : super(key: key);

  const AddressManagementBottomCard({
    Key? key,
    this.totalPrice = 0.0,
  }) : super(key: key);
  ...
  @override
  _AddressManagementBottomCardState createState() => _AddressManagementBottomCardState();
}

final ItemController itemController = Get.put(ItemController());

class _AddressManagementBottomCardState extends State<AddressManagementBottomCard> {
  @override
  void initState() {
